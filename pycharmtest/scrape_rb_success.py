...
def getSchedule(teamId):
    games = []
    soup = getSoup('http://espn.go.com/college-football/team/schedule/_/id/' + teamId)
    for tag in soup.find_all(id="score"):
        games.put(tag.find('a')['href'].replace('/ncf/recap?id=', ''))

    return games
#     <li class="score"><a href="/ncf/recap?id=400603827">35-17</a> </li>
